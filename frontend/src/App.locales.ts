...
export const locales: Record<Language, Translations> = {
    en: {
        ...
        placeholder: "Placeholder View - Coming in subsequent phases",
    },
    fr: {
        title: "Hub Étudiant",
        ...
        placeholder: "Aperçu de l'espace réservé - Phases suivantes",
    },
    es: {
        ...
        placeholder: "Vista de marcador de posición - Próximas fases",
    },
};
